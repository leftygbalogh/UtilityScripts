...
sleep 1
        ...
        echo "    - First District Court of Thankyou"
        echo "          (novel mentioned in Jailbird)"
        echo "    - The Gospel from Outer Space "
        echo "          (novel mentioned in Slaughterhouse-Five)"
        ...
        echo "    - Maniacs in the Fourth Dimension "
        echo "          (novel mentioned in Slaughterhouse-Five)"
        echo "    - The Money Tree (novel mentioned in Slaughterhouse-Five)"
        echo "    - Now It Can Be Told "
        echo "          (novel mentioned in Breakfast of Champions)"
        echo "    - Oh Say Can You Smell? "
        echo "          (novel mentioned in God Bless You, Mr. Rosewater)"
        echo "    - The Pan-Galactic Memory Bank "
        echo "          (novel mentioned in Breakfast of Champions)"
        ...
        echo "    - The Son of Jimmy Valentine "
        echo "          (novel mentioned in Breakfast of Champions)"
