...
sleep 3
        ...
        echo "║       (in Breakfast of Champions)"
        echo "║ - The Big Board (in Slaughterhouse-Five)"
        echo "║ - The Era of Hopeful Monsters (in Galápagos)"
        echo "║ - First District Court of Thankyou (in Jailbird)"
        echo "║ - The Gospel from Outer Space (in Slaughterhouse-Five)"
        echo "║ - The Gutless Wonder (in Slaughterhouse-Five)"
        echo "║ - How You Doin'? (in Breakfast of Champions)"
        echo "║ - Maniacs in the Fourth Dimension (in Slaughterhouse-Five)"
        echo "║ - The Money Tree (in Slaughterhouse-Five)"
        echo "║ - Now It Can Be Told (in Breakfast of Champions)"
        echo "║ - Oh Say Can You Smell? (in God Bless You, Mr. Rosewater)"
        echo "║ - The Pan-Galactic Memory Bank (in Breakfast of Champions)"
        echo "║ - The Pan-Galactic Straw Boss a.k.a. Mouth Crazy "
        echo "║       (in Breakfast of Champions)"
        echo "║ - The Pan-Galactic Three-Day Pass "
        echo "║       (in God Bless You, Mr. Rosewater)"
        echo "║ - Plague on Wheels (in Breakfast of Champions)"
        echo "║ - The Smart Bunny (in Breakfast of Champions)"
        echo "║ - The Son of Jimmy Valentine (in Breakfast of Champions)"
        echo "║ - 2BR02B (in God Bless You, Mr. Rosewater)"
        echo "║ - Venus on the Half-Shell (in God Bless You, Mr. Rosewater)"
        echo "╚════════════════════════════════╤════════════════════════════════╝"
sleep 5
